...
from app.interfaces.schema.shell import ShellExecuteRequest, ShellReadRequest, ShellWaitRequest, \
    ShellWriteRequest, ShellKillRequest
from app.interfaces.service_dependencies import get_shell_service
from app.models.shell import ShellWaitResult, ShellWriteResult, ShellKillResult, \
    ShellExecuteResult, ShellReadResult
